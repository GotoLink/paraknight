		...
		for (int var3 = 0; var3 < 3; ++var3) {
			for (int var4 = MathHelper.floor_double(var2.posX - 25.0D); var4 < MathHelper.floor_double(var2.posX + 25.0D); ++var4) {
				for (int var5 = MathHelper.floor_double(var2.posZ - 25.0D); var5 < MathHelper.floor_double(var2.posZ + 25.0D); ++var5) {
					if (var3 > 0 && var4 > MathHelper.floor_double(var2.posX - 5.0D) && var4 < MathHelper.floor_double(var2.posX + 5.0D) && var5 > MathHelper.floor_double(var2.posZ - 5.0D)
							&& var5 < MathHelper.floor_double(var2.posZ + 5.0D)) {
						var1.setBlock(var4, MathHelper.floor_double(var2.posY + 20.0D + var3), var5, Block.waterStill.blockID);
					} else {
						var1.setBlock(var4, MathHelper.floor_double(var2.posY + 20.0D + var3), var5, Block.grass.blockID);
					}
				}
			}
		}
