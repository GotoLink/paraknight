...
public class EntitySlimeFX extends EntityFX
{
    public EntitySlimeFX(World var1, double var2, double var4, double var6, Item var8)
    {
        ...
        this.setParticleIcon(FMLClientHandler.instance().getClient().renderEngine,var8.getIconIndex(new ItemStack(var8)));
    ...
    {
        float var8 = ((float)this.particleTextureIndexX / 16F + this.particleTextureJitterX / 4.0F) / 16.0F;
        float var9 = var8 + 0.01560938F;
        float var10 = ((float)this.particleTextureIndexX / 16F + this.particleTextureJitterY / 4.0F) / 16.0F;
