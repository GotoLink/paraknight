...
public class ModelLawnMower extends ModelBase
{
    ...
    public ModelLawnMower()
    {
        ...
        byte b2 = 20;
        byte b3 = 4;
        this.lawnMowerSides[0].addBox((float)(-b0 / 2), (float)(-b2 / 2 + 2), -3.0F, b0, b2 - 4, 4, 0.0F);
        this.lawnMowerSides[0].setRotationPoint(0.0F, (float)b3, 0.0F);
        this.lawnMowerSides[1].addBox((float)(-b0 / 2 + 2), (float)(-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.lawnMowerSides[1].setRotationPoint((float)(-b0 / 2 + 1), (float)b3, 0.0F);
        this.lawnMowerSides[2].addBox((float)(-b0 / 2 + 2), (float)(-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.lawnMowerSides[2].setRotationPoint((float)(b0 / 2 - 1), (float)b3, 0.0F);
        this.lawnMowerSides[3].addBox((float)(-b0 / 2 + 2), (float)(-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.lawnMowerSides[3].setRotationPoint(0.0F, (float)b3, (float)(-b2 / 2 + 1));
        this.lawnMowerSides[4].addBox((float)(-b0 / 2 + 2), (float)(-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.lawnMowerSides[4].setRotationPoint(0.0F, (float)b3, (float)(b2 / 2 - 1));
