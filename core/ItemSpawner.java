	    ...
	    else
	    {
	        ...
	        else
	        {
	            if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
	            {
	                ...
	                Entity entity = makeEntity(par1ItemStack, par2World, (double)((float)i + 0.5F), (double)((float)j + 1F), (double)((float)k + 0.5F));
	                if(entity!=null)
	                {
		                entity.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
